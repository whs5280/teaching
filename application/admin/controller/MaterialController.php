...
class MaterialController extends Controller
{
    ...
    //添加
    public function add(Request $request, Material $model, MaterialValidate $validate)
    {
        if ($request->isPost()) {
            $param           = $request->param();
    ...
    //修改
    public function edit($id, Request $request, Material $model, MaterialValidate $validate)
    {
    ...
    //删除
    public function del($id, Material $model)
    {
